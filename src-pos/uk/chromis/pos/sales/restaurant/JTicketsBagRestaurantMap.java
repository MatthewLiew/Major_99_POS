...
public class JTicketsBagRestaurantMap extends JTicketsBag {
    ...
    // Edited By Matthew
    private static final Icon ICO_NOT_SEND = new ImageIcon(Place.class.getResource("/uk/chromis/images/edit_group_animated.gif"));
    private static final Icon ICO_OCU = new ImageIcon(Place.class.getResource("/uk/chromis/images/edit_group.png"));
    private String ICO_TABLE_ORI = "/uk/chromis/images/tables.png";
    private String ICO_TABLE_ANI = "/uk/chromis/images/tables_animated.gif";
    ...
    public JTicketsBagRestaurantMap(AppView app, TicketsEditor panelticket) {
        ...
        m_jpanelticket = new JPanelTicket(app, this) {
            @Override
...
//              Msg Changed to NewServer
    ...
    // Edited By Matthew
    public void exitSalePanel(){
        restDB.clearTableLock(getTable());
        newTicket();
    }
...
// We have set the option show details on table.  
                    ...
                    if(place.hasPeople()){
                        ...
                        if(ticket.getLinesCount()>0){
                            for(int i = ticket.getLinesCount()-1; i>= 0 ; i--){
                                ...
                                if(kitchen){
                                    place.getButton().setIcon(ICO_NOT_SEND);
                                } 
                                else {
                                    place.getButton().setIcon(ICO_OCU);
                                }
                            }
                        } else {
                            place.getButton().setIcon(ICO_OCU);
                ...
                if(allTable){
//                    m_restaurantmap.setTablesIcon(allTable, ICO_TABLE_ANI);
//                    if(m_jpanelticket==null){
//                        System.out.println("m_jpanelticket NULL");
//                    } else {
                        m_jpanelticket.setPrintToKitchenIcon(allTable, ICO_TABLE_ANI);
//                    }
                    
                } else {
//                    m_restaurantmap.setTablesIcon(allTable, ICO_TABLE_ORI);
//                    if(m_jpanelticket==null){
//                        System.out.println("m_jpanelticket NULL");
//                    } else {
                        m_jpanelticket.setPrintToKitchenIcon(allTable, ICO_TABLE_ORI);
//                    }
                }
