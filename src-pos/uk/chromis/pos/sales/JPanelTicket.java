...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    private static JTicketsBagRestaurantMap m_restaurant = null;
    
    public JPanelTicket(AppView app, JTicketsBagRestaurantMap restaurant) {
...
// if the autologoff and inactivity is configured the setup the timer with action
		...
		// Edited By Matthew - control edit line button by permission
...
// check if the old table and the new table are the same                      
    ...
    private void refreshTicket() {
        ...
        if (m_oTicket == null) {
            ...
            m_jTotalItems.setText(null);                                        // Edited By Matthew
    ...
    private void printPartialTotals() {
        if (m_oTicket.getLinesCount() == 0) {
            ...
            m_jTotalItems.setText(m_oTicket.printArticlesCount());              // Edited By Matthew
...
// if this is ticket does not have a pickup code assign on now            
    ...
    public void evalScriptAndRefresh(String resource, ScriptArg... args) {
        if (resource == null) {
			...
			// Edited By Matthew
			if(resource.equals("script.linediscount")){
                TicketLineInfo oLine = m_oTicket.getLine(m_ticketlines.getSelectedIndex()+1);
                visorTicketLine(oLine);
            } else if (resource.equals("script.totaldiscount")){
                TicketLineInfo oLine = m_oTicket.getLine(m_oTicket.getLinesCount()-1);
                visorTicketLine(oLine);
            } else if (resource.equals("script.adjustment")){
                TicketLineInfo oLine = m_oTicket.getLine(m_oTicket.getLinesCount()-1);
                visorTicketLine(oLine);
            }
        }
...
// End mod            
    ...
    // Edited By Matthew
     public void setPrintToKitchenIcon(boolean hasOrderNotSend, String resource){
//        m_TablePlan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/images/tables.png")));
        if(hasOrderNotSend){
            if(j_btnKitchenPrt == null){
                System.out.println("IM NULL");
            }
            // System.out.println(resource);
            j_btnKitchenPrt.setIcon(new NullIcon(1, 1));
        } else {
            if(j_btnKitchenPrt == null){
                System.out.println("IM NULL");
            }
    ...
    private void initComponents() {
		...
		m_jLblTotalEuros4 = new javax.swing.JLabel();							// Edited By Matthew
        m_jLblTotalEuros3 = new javax.swing.JLabel();
        m_jLblTotalEuros2 = new javax.swing.JLabel();
        m_jLblTotalEuros1 = new javax.swing.JLabel();
		m_jTotalItems = new javax.swing.JLabel();								// Edited By Matthew
        ...
        m_checkStock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uk/chromis/images/search32.png"))); // NOI18N
        ...
        m_jPanTotals.setPreferredSize(new java.awt.Dimension(425, 60));         // Edited By Matthew
		// m_jPanTotals.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true));
        m_jPanTotals.setLayout(new java.awt.GridLayout(2, 4, 4, 0));            // Edited By Matthew
        ...
        m_jLblTotalEuros4.setLabelFor(m_jTotalItems);							// Edited By Matthew
        m_jLblTotalEuros4.setText("Total Item(s)"); // NOI18N
		...
		// Edited By Matthew
		m_jTotalItems.setBackground(m_jEditLine.getBackground());
        m_jTotalItems.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        m_jTotalItems.setForeground(m_jEditLine.getForeground());
        m_jTotalItems.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        m_jTotalItems.setLabelFor(m_jTotalItems);
        m_jTotalItems.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 1, true));
        m_jTotalItems.setMaximumSize(new java.awt.Dimension(125, 25));
        m_jTotalItems.setMinimumSize(new java.awt.Dimension(80, 25));
        m_jTotalItems.setOpaque(true);
        m_jTotalItems.setPreferredSize(new java.awt.Dimension(100, 25));
        m_jTotalItems.setRequestFocusEnabled(false);
        m_jPanTotals.add(m_jTotalItems);
...
// test if there is valid ticket in the system at this till to be printed
	...
	private javax.swing.JLabel m_jLblTotalEuros4;								// Edited By Matthew
	...
	private javax.swing.JLabel m_jTotalItems;									// Edited By Matthew
