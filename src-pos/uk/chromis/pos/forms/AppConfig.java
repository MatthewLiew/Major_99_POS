...
public class AppConfig implements AppProperties {
    ...
    public static AppConfig getInstance() {
        if (instance == null) {
            instance = new AppConfig(new File(System.getProperty("user.dir"), AppLocal.APP_ID + ".properties"));
        }
        return instance;
    }

    private File getDefaultConfig() {
        return new File(new File(System.getProperty("user.dir")), AppLocal.APP_ID + ".properties");
    }
    ...
    private void loadDefault() {
        ...
        m_propsconfig.setProperty("db.URL", "jdbc:derby:" + new File(new File(System.getProperty("user.dir")), AppLocal.APP_ID + "-database").getAbsolutePath() + ";create=true");
        ...
        m_propsconfig.setProperty("paper.receipt.x", "10");									// Edited By Matthew
