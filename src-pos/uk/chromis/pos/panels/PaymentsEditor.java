...
public final class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public PaymentsEditor(AppView oApp, DirtyManager dirty) {
		...
		// Edited By Matthew
		m_ReasonModel.add(new PaymentReasonPositive("excess", AppLocal.getIntString("transpayment.excess"))); 
        m_ReasonModel.add(new PaymentReasonNegative("short", AppLocal.getIntString("transpayment.short")));		
