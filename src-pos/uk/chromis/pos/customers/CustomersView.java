...
public final class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueInsert() {
        ...
        txtCurdebt.setText(null);
        txtCurdate.setText(null);
		// Edited By Matthew - always shows true
    ...
    public Object createValue() throws BasicException {
		...
		// Edited By Matthew - insert name value into searchkey
    ...
    private void initComponents() {
		...
		// Edited By Matthew - hide search key label
		jLabel8.setVisible(false);
		
        m_jSearchkey.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
		// Edited By Matthew - hide search key text field
